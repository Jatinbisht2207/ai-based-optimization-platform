...
# st.markdown("""
# The chart displays the most influential features driving energy consumption predictions.

# Higher SHAP importance indicates stronger impact on the model output.

# This improves system transparency and supports trustworthy AI-driven decision-making.
# """)